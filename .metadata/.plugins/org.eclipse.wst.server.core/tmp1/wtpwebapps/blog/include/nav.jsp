				...
				<div class="container box_1620">
					...
					<div class="collapse navbar-collapse offset" id="navbarSupportedContent">
						<ul class="nav navbar-nav menu_nav">
							...
							<li class="nav-item"><a class="nav-link" href="/blog/board?cmd=write">Posting</a></li>
							<c:choose>
								<c:when test="${empty sessionScope.username}">
									<li class="nav-item"><a class="nav-link" href="/blog/member?cmd=join">Join</a></li>
									<li class="nav-item"><a class="nav-link" href="/blog/member?cmd=login">Login</a></li>
								</c:when>
								<c:otherwise>
									<li class="nav-item"><a class="nav-link" href="/blog/member?cmd=update">MyPage</a></li>
									<li class="nav-item"><a class="nav-link" href="/blog/member?cmd=logout">Logout</a></li>
								</c:otherwise>
							</c:choose>
